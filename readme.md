...
Задача состоит в том, чтобы с помощью [хеш таблицы](https://ru.wikipedia.org/wiki/%D0%A5%D0%B5%D1%88-%D1%82%D0%B0%D0%B1%D0%BB%D0%B8%D1%86%D0%B0) написать сценарий, в котором в программу один раз загружается большой объём данных, а затем последовательно обрабатываются множество запросов на поиск данных.
...
Проведём сравнение разных алгоритмов хеширования по заселённости создаваемой ими хеш таблицы, а также демонстрирует 3 разных способа ассемблерных оптимизаций алгоритма поиска по хэш таблице.
