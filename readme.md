...
| Кэш 1 уровня                   | 64К(на ядро)  |
| Кэш 2 уровня                   | 2560К(на ядро)|
| Кэш 3 уровня                   | 6М(всего)     |
...
Начальные данные:
| Количество операций в функции поиска, $10^9$ | Время исполнения программы, $10^8$ | 
|----------------------------------------------|------------------------------------|
|           20                                 |               131                  |     
...
| Количество операций в функции поиска, $10^9$ | Время исполнения программы, $10^8$ | Ускорение относительно базовой версии | ускорение относительно предыдущей версии |
|----------------------------------------------|------------------------------------|---------------------------------------|------------------------------------------|
|           7.6                                |               76                   |              1.72(72%)                |                1.72(72%)                 |
